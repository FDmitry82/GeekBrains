...
class RandomCard:
    ...
    # Получаю случайные индексы в строку в кол-ве 27 штук
    ...
    # Получаю матрицу 3 строки и 9 значений в строку в кол-ве 27 штук
    def card(self):
...
class Game:
    ...
    # Поиск в карточки и зачеркивание бочонка
    @staticmethod
